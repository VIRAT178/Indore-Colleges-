  ...
  app.get('/api/institutes', async (req, res) => {
    try {
      ...
      const partnerInstitutes = approvedPartners.map((cp: any) => ({
        ...
        rating: 5.0,
        totalReviews: 0,
        image: cp.image || '/malwa_institute_campus.jpg', // Default fallback image
  ...
  app.put('/api/college-partner/:id', async (req, res) => {
    ...
    try {
      ...
      const requestedChanges: any = {
        ...
        description: updateData.description ?? existingCollege.description,
