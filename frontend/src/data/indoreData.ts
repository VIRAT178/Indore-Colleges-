...
export const INDORE_INSTITUTES: Institute[] = [
  ...
  {
    id: 'softvision-college',
    name: 'Softvision College (SV)',
    type: 'college',
    category: 'Arts & Science',
    boardOrAffiliation: 'DAVV',
    location: 'World Cup Square',
    feePerAnnum: 65000,
    rating: 4.6,
    googleRating: 4.6,
    indoreRating: 4.8,
    totalReviews: 1200,
    image: '/softvision-college.jpg',
    description: 'Softvision College (SV Indore), situated near World Cup Square, is a premier higher education institution affiliated with Devi Ahilya Vishwavidyalaya. Renowned for its vibrant academic environment across Bachelor of Arts (BA), BBA, Biotechnology, and Computer Sciences, it provides career-ready skill workshops and active placement training.',
    facilities: ['Modern Biotech Labs', 'Computer Labs', 'Digital Library', 'Auditorium', 'Seminar Hall', 'Cafeteria', 'Sports Arena'],
    establishedYear: 2001,
    coordinates: { lat: 22.7196, lng: 75.8920 },
    contactEmail: 'admissions@softvision.ac.in',
    contactPhone: '0731-2578500',
    website: 'https://softvision.ac.in/',
    address: 'World Cup Square, Pipliyahana Road, Indore - 452016, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 12 km)',
    approval: 'UGC Recognized, Affiliated to Devi Ahilya Vishwavidyalaya (DAVV)',
    selectionCriteria: 'Merit-based admission as per DAVV university e-Pravesh guidelines.',
    updates: [
      'Admissions active for BA, BBA, B.Com, and B.Sc streams for the 2026 academic session.',
      'Active career incubation programs and campus placement drives underway.'
    ],
    coursesList: [
      { name: 'Bachelor of Arts [BA]', duration: '3 Years', fees: '₹45,000 (1st Year Fees)', specializations: ['Psychology', 'Economics', 'English Literature', 'Political Science'] },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹65,000 (1st Year Fees)' },
      { name: 'Bachelor of Science [B.Sc]', duration: '3 Years', fees: '₹55,000 (1st Year Fees)', specializations: ['Biotechnology', 'Computer Science'] }
    ],
    placements: {
      highest: 'INR 8.50 LPA',
      average: 'INR 4.00 LPA',
      lowest: 'INR 2.80 LPA',
      recruiters: ['TCS', 'Cipla', 'Wipro', 'ICICI Prudential', 'Concentrix', 'Infosys']
    },
    facultyList: [
      { name: 'Dr. Meena Agarwal', qualification: 'Director & Principal' },
      { name: 'Prof. Ananya Sen', qualification: 'HOD, Humanities & Arts' }
    ],
    scholarships: [
      { name: 'SV Academic Excellence Award', criteria: '85%+ aggregate in Class 12th', benefits: 'INR 10,000 scholarship award' }
    ],
    cutoffs: [
      { course: 'Bachelor of Arts [BA]', rank: 'DAVV merit round cutoff (65%+)' }
    ]
  },
  {
    id: 'alexia-college',
    name: 'Alexia College Of Professional Studies',
    type: 'college',
    category: 'Arts & Science',
    boardOrAffiliation: 'DAVV',
    location: 'A.B. Road',
    ...
    indoreRating: 4.6,
    totalReviews: 402,
    image: '/alexia-college.jpg',
    description: 'Alexia College Of Professional Studies, prominently located at Swadesh Bhawan on AB Road, is acclaimed for accessible and high-value higher education in Indore. Offering flexible and affordable Bachelor of Arts (BA), Commerce, and Science curricula with experienced teaching faculty, it is a preferred destination for undergraduate humanities aspirants.',
    facilities: ['Spacious Classrooms', 'Reading Library', 'Computer Center', 'Seminar Hall', 'Wi-Fi Campus', 'Cafeteria'],
    establishedYear: 2012,
    coordinates: { lat: 22.7210, lng: 75.8750 },
    contactEmail: 'admissions@alexiacollege.in',
    contactPhone: '088890 00000',
    website: 'https://alexiacollege.in/',
    address: 'Swadesh Bhawan, 25, AB Rd, Indore - 452001, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 9 km)',
    approval: 'UGC Recognized, Affiliated to Devi Ahilya Vishwavidyalaya (DAVV)',
    selectionCriteria: 'Merit-based on 10+2 board examination marks with personal counseling.',
    updates: [
      'Admissions open for BA, B.Com, and BBA batches for 2026-27 with scholarship incentives.',
      'Affordable fee structures with installment facilities for local and regional students.'
    ],
    coursesList: [
      { name: 'Bachelor of Arts [BA]', duration: '3 Years', fees: '₹35,000 (1st Year Fees)', specializations: ['Sociology', 'Political Science', 'History', 'Hindi Literature', 'English'] },
      { name: 'Bachelor of Commerce [B.Com]', duration: '3 Years', fees: '₹38,000 (1st Year Fees)' },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹48,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 6.00 LPA',
      average: 'INR 3.20 LPA',
      lowest: 'INR 2.20 LPA',
      recruiters: ['Teleperformance', 'TCS', 'ICICI Bank', 'Concentrix', 'Paytm']
    },
    facultyList: [
      { name: 'Prof. R. C. Mishra', qualification: 'Principal' },
      { name: 'Prof. Sunita Jain', qualification: 'Faculty of Arts & Humanities' }
    ],
    scholarships: [
      { name: 'Alexia Merit Concession Scheme', criteria: 'Above 75% in 10+2', benefits: 'Up to 25% fee waiver' }
    ],
    cutoffs: [
      { course: 'Bachelor of Arts [BA]', rank: '10+2 passing marks (minimum 50%)' }
    ]
  },
  {
    id: 'gacc-indore',
    name: 'Shri Atal Bihari Vajpayee Government Arts and Commerce College (GACC)',
    type: 'college',
    category: 'Arts & Science',
    boardOrAffiliation: 'Government',
    location: 'Bhawarkua',
    feePerAnnum: 15000,
    rating: 4.1,
    googleRating: 4.1,
    indoreRating: 4.7,
    totalReviews: 1400,
    image: '/gacc-indore.jpg',
    description: 'Shri Atal Bihari Vajpayee Government Arts and Commerce College (GACC Indore), established in 1891, is one of the oldest and most prestigious heritage government institutions in Central India. Situated at Bhawarkua on AB Road, GACC is nationally celebrated for producing eminent civil servants, authors, and scholars across Arts, Humanities, and Commerce.',
    facilities: ['Grand Heritage Campus', 'Extensive Central Library (1 Lakh+ books)', 'Large Sports Grounds', 'NSS & NCC Wings', 'Auditorium', 'Hostels', 'Canteen'],
    establishedYear: 1891,
    coordinates: { lat: 22.6934, lng: 75.8652 },
    contactEmail: 'gaccindore@mp.gov.in',
    contactPhone: '0731-2464111',
    website: 'http://www.gaccindore.com/',
    address: 'Bhawar Kuan, A.B. Road, Indore - 452001, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 10 km)',
    approval: 'Government Autonomous College, Affiliated to DAVV, NAAC Grade A Accredited',
    selectionCriteria: 'MP Higher Education online centralized e-Pravesh merit list based on 10+2 percentage.',
    updates: [
      'MP e-Pravesh counseling registrations open for BA, B.Com, and MA admissions 2026.',
      'Civil Services examination preparation circles and free coaching guidance actively running.'
    ],
    coursesList: [
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹18,000 (1st Year Fees)' },
      { name: 'Bachelor of Arts [BA]', duration: '3 Years', fees: '₹12,000 (1st Year Fees)', specializations: ['Economics', 'History', 'Political Science', 'Sociology', 'Hindi Literature', 'English Literature', 'Geography', 'Philosophy', 'Psychology'] },
      { name: 'Bachelor of Commerce [B.Com]', duration: '3 Years', fees: '₹14,000 (1st Year Fees)' },
      { name: 'Master of Arts [MA]', duration: '2 Years', fees: '₹10,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 6.50 LPA',
      average: 'INR 3.20 LPA',
      lowest: 'INR 2.00 LPA',
      recruiters: ['State Government Bodies', 'Banking Services', 'TCS', 'Wipro BPO', 'Concentrix', 'Insurance Sector']
    },
    facultyList: [
      { name: 'Dr. Suresh Silawat', qualification: 'Principal & Senior Professor' },
      { name: 'Dr. Anita Joshi', qualification: 'HOD, Political Science' }
    ],
    scholarships: [
      { name: 'MP Post-Matric State Scholarship', criteria: 'Reserved categories and meritorious domicile students', benefits: 'Full tuition fee reimbursement' },
      { name: 'Gaon Ki Beti Scheme', criteria: 'Meritorious rural female students', benefits: 'Financial aid per academic year' }
    ],
    cutoffs: [
      { course: 'Bachelor of Arts [BA]', rank: 'MP e-Pravesh Cutoff (approx 72% - 85%)' }
    ]
  },
  {
    id: 'radiant-institute',
    name: 'Radiant Institute of Management & Science',
    type: 'college',
    category: 'Management',
    boardOrAffiliation: 'DAVV',
    location: 'Bakhtawar Ram Nagar',
    feePerAnnum: 55000,
    rating: 3.8,
    googleRating: 3.8,
    indoreRating: 4.1,
    totalReviews: 512,
    image: '/radiant-institute.jpg',
    description: 'Radiant Institute of Management and Science (RIMS Indore), situated at Bakhtawar Ram Nagar, is a vibrant education hub offering dynamic Bachelor of Arts (BA), BBA, B.Com, and MSW programs. With a strong emphasis on practical soft-skills bootcamps, career mentoring, and student extracurricular activities, it fosters holistic student growth.',
    facilities: ['Smart Classrooms', 'Air-conditioned Auditorium', 'Digital Library', 'Computer Center', 'Sports Arena', 'Cafeteria'],
    establishedYear: 2009,
    coordinates: { lat: 22.7090, lng: 75.8820 },
    contactEmail: 'info@radiantindore.com',
    contactPhone: '079090 00000',
    website: 'https://radiantindore.com/',
    address: 'Sector A, Bakhtawar Ram Nagar, Tilak Nagar, Indore - 452018, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 11 km)',
    approval: 'Affiliated to Devi Ahilya Vishwavidyalaya (DAVV), Approved by Higher Education MP',
    selectionCriteria: 'Direct admission and merit-based screening on 10+2 board exam results.',
    updates: [
      'Admissions underway for BA, BBA, B.Com, and professional certification modules 2026.',
      'Active placement and internship tie-ups with leading local enterprises.'
    ],
    coursesList: [
      { name: 'Bachelor of Arts [BA]', duration: '3 Years', fees: '₹40,000 (1st Year Fees)', specializations: ['Journalism', 'Psychology', 'Public Administration', 'Sociology'] },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹60,000 (1st Year Fees)' },
      { name: 'Bachelor of Commerce [B.Com]', duration: '3 Years', fees: '₹45,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 7.20 LPA',
      average: 'INR 3.50 LPA',
      lowest: 'INR 2.40 LPA',
      recruiters: ['Teleperformance', 'HDFC Bank', 'Flipkart', 'Genpact', 'Axis Bank']
    },
    facultyList: [
      { name: 'Dr. Alok Verma', qualification: 'Director & Academic Head' },
      { name: 'Prof. Neha Dixit', qualification: 'Associate Professor' }
    ],
    scholarships: [
      { name: 'Radiant Talent Scholarship', criteria: '80% aggregate in 12th', benefits: 'INR 8,000 annual concession' }
    ],
    cutoffs: [
      { course: 'Bachelor of Arts [BA]', rank: 'Direct merit minimum 50% in 10+2' }
    ]
  },
  {
    ...
    category: 'Management',
    boardOrAffiliation: 'DAVV',
    location: 'Bombay Hospital Road',
    feePerAnnum: 62000,
    rating: 4.4,
    googleRating: 4.4,
    indoreRating: 4.4,
    totalReviews: 370,
    image: '/pioneer-institute.jpg',
    description: 'Pioneer Institute of Professional Studies, situated near Bombay Hospital Service Road in Indore, is an autonomous premier institution established in 1996. Approved by AICTE and affiliated with Devi Ahilya Vishwavidyalaya (DAVV), it is highly acclaimed for professional degree courses in BCA, BBA, MBA, and B.Com with advanced computer labs and active corporate placement drives.',
    facilities: ['High-Tech Computer Labs', 'Central Management Library', 'Air-Conditioned Seminar Halls', 'Auditorium', 'Wi-Fi Campus', 'Sports Ground', 'Placement Cell'],
    establishedYear: 1996,
    coordinates: { lat: 22.7580, lng: 75.8950 },
    contactEmail: 'pioneer@pioneer.ac.in',
    contactPhone: '0731-2570645',
    website: 'https://www.pioneer.ac.in/',
    address: 'Near Bombay Hospital Service Road, Sector R, Mahalaxmi Nagar, Indore - 452010, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 14 km)',
    approval: 'Autonomous, AICTE Approved, Affiliated to DAVV, NAAC Accredited',
    selectionCriteria: 'Merit-based on 10+2 marks for BCA/BBA; CMAT / entrance test for MBA.',
    updates: [
      'Admissions open for BCA, BBA, and MBA programs for 2026-27 academic session.',
      'Active campus recruitment drives with leading national IT and financial organizations.'
    ],
    coursesList: [
      { name: 'Bachelor of Computer Applications [BCA]', duration: '3 Years', fees: '₹55,000 (1st Year Fees)', specializations: ['Cloud Computing', 'Web Technologies', 'Software Development'] },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹62,000 (1st Year Fees)' },
      { name: 'Master of Business Administration [MBA]', duration: '2 Years', fees: '₹78,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 10.50 LPA',
      average: 'INR 4.20 LPA',
      lowest: 'INR 2.80 LPA',
      recruiters: ['TCS', 'Wipro', 'Infosys', 'ICICI Bank', 'Concentrix', 'Capgemini']
    },
    facultyList: [
      { name: 'Dr. P. N. Mishra', qualification: 'Director & Professor' },
      { name: 'Dr. Mona Tandon', qualification: 'HOD, Computer Applications' }
    ],
    scholarships: [
      { name: 'Pioneer Merit Award', criteria: '85%+ in 10+2', benefits: 'INR 10,000 tuition fee assistance' }
    ],
    cutoffs: [
      { course: 'Bachelor of Computer Applications [BCA]', rank: '10+2 merit cutoff 60%+' }
    ]
  },
  {
    id: 'christian-eminent',
    name: 'Christian Eminent College',
    type: 'college',
    category: 'Arts & Science',
    boardOrAffiliation: 'DAVV',
    location: 'HIG Main Rd',
    feePerAnnum: 45000,
    rating: 4.3,
    googleRating: 4.3,
    indoreRating: 4.2,
    totalReviews: 379,
    image: '/christian-eminent.jpg',
    description: 'Christian Eminent College of Management, Professional Education and Computer Applications, established in 1996 on HIG Main Road in Indore, is an autonomous NAAC Grade "A" institution affiliated with DAVV. Acclaimed for accessible, affordable, and high-standard education in BCA, B.Sc Computer Science, BBA, and Commerce.',
    facilities: ['Advanced Computer Labs', 'Central Digital Library', 'Electronics & Science Labs', 'Air-Conditioned Seminar Hall', 'Wi-Fi Campus', 'Canteen', 'Sports Arena'],
    establishedYear: 1996,
    coordinates: { lat: 22.7350, lng: 75.8820 },
    contactEmail: 'info@christianeminent.com',
    contactPhone: '078048 00800',
    website: 'https://christianeminent.com/',
    address: 'F 7, HIG Main Rd, LIG Colony, Indore - 452011, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 10 km)',
    approval: 'Autonomous, NAAC Grade A Accredited, UGC Recognized, Affiliated to DAVV',
    selectionCriteria: 'Merit-based admission as per DAVV centralized e-Pravesh norms.',
    updates: [
      'Admissions active for BCA, B.Sc Computer Science, and BBA 2026 batches.',
      'Scholarship concession available for meritorious regional students.'
    ],
    coursesList: [
      { name: 'Bachelor of Computer Applications [BCA]', duration: '3 Years', fees: '₹42,000 (1st Year Fees)', specializations: ['Full Stack Development', 'Database Management', 'Python & AI'] },
      { name: 'Bachelor of Science [B.Sc Computer Science]', duration: '3 Years', fees: '₹38,000 (1st Year Fees)' },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹45,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 7.50 LPA',
      average: 'INR 3.50 LPA',
      lowest: 'INR 2.40 LPA',
      recruiters: ['Teleperformance', 'TCS', 'Wipro', 'Tech Mahindra', 'HDFC Bank']
    },
    facultyList: [
      { name: 'Dr. Rajesh Vyas', qualification: 'Principal & Academic Head' },
      { name: 'Prof. Sandeep Kashyap', qualification: 'HOD, Computer Applications' }
    ],
    scholarships: [
      { name: 'Eminent Merit Concession', criteria: 'Above 80% in 12th', benefits: 'Up to 20% tuition concession' }
    ],
    cutoffs: [
      { course: 'Bachelor of Computer Applications [BCA]', rank: '10+2 with Mathematics/CS minimum 50%' }
    ]
  },
  {
    id: 'holkar-science',
    ...
    indoreRating: 4.9,
    totalReviews: 2200,
    image: '/holkar-science.jpg',
    description: 'Government Model Autonomous Holkar Science College, established in 1891 by Shivaji Rao Holkar, is Central India\'s premier historic science and technology institution. Awarded NAAC Grade "A++" with a score of 3.64, it features world-class computer science and IT faculties, expansive botanical grounds, and premier BCA and B.Sc programs.',
    facilities: ['State-of-the-Art BCA Computing Labs', 'Central Heritage Library (1.5 Lakh+ books)', 'Research Innovation Hub', 'Astronomical Observatory', 'NCC & NSS Wings', 'Large Sports Grounds', 'Canteen'],
    establishedYear: 1891,
    coordinates: { lat: 22.6945, lng: 75.8640 },
    contactEmail: 'principalhsc@rediffmail.com',
    contactPhone: '0731-2464074',
    website: 'https://collegeholkar.org/',
    address: 'AB Rd, near Bhawarkua Square, Indore - 452001, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 9 km)',
    approval: 'Government Autonomous, NAAC Grade A++ Accredited (CGPA 3.64), Affiliated to DAVV',
    selectionCriteria: 'Centralized MP e-Pravesh online merit based on 10+2 examination percentage.',
    updates: [
      'MP e-Pravesh portal counseling registrations live for BCA and B.Sc Computer Science 2026.',
      'Ranked #1 Government Science & IT College in Madhya Pradesh by Higher Education Department.'
    ],
    coursesList: [
      { name: 'Bachelor of Computer Applications [BCA]', duration: '3 Years', fees: '₹18,000 (1st Year Fees)', specializations: ['Artificial Intelligence', 'Data Science', 'Cyber Security', 'Software Engineering'] },
      { name: 'B.Sc Computer Science & IT', duration: '3 Years', fees: '₹14,000 (1st Year Fees)' },
      { name: 'Master of Science [M.Sc Computer Science]', duration: '2 Years', fees: '₹16,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 12.00 LPA',
      average: 'INR 4.50 LPA',
      lowest: 'INR 3.00 LPA',
      recruiters: ['TCS Digital', 'Infosys', 'Wipro', 'Cognizant', 'L&T Infotech', 'State Government Bodies']
    },
    facultyList: [
      { name: 'Dr. Suresh T. Silawat', qualification: 'Principal & Senior Scientist' },
      { name: 'Dr. Pradeep Sharma', qualification: 'Head, Computer Science Department' }
    ],
    scholarships: [
      { name: 'MP State Post-Matric Scholarship', criteria: 'Eligible domicile & reserved category students', benefits: 'Full fee reimbursement' },
      { name: 'Medhavi Chhatra Yojana', criteria: '70%+ in MP Board / 85%+ in CBSE', benefits: 'Full government scholarship' }
    ],
    cutoffs: [
      { course: 'Bachelor of Computer Applications [BCA]', rank: 'MP e-Pravesh cutoff (80% - 92%)' }
    ]
  },
  {
    id: 'gujarati-professional',
    ...
    indoreRating: 4.1,
    totalReviews: 244,
    image: '/gujarati-professional.jpg',
    description: 'Shri R.G.P. Gujarati Professional Institute, located near Bombay Hospital Service Road in Scheme 54, Indore, is an esteemed institution managed by Shri Gujarati Samaj. Affiliated with DAVV and approved by AICTE, it offers quality, value-driven education across MBA, BBA, BCA, and Commerce programs with robust industry connectivity.',
    facilities: ['Advanced Computing Labs', 'Central Management Library', 'Air-Conditioned Seminar Hall', 'Auditorium', 'Spacious Classrooms', 'Cafeteria', 'Indoor Games'],
    establishedYear: 2001,
    coordinates: { lat: 22.7590, lng: 75.8940 },
    contactEmail: 'info@rgpgujaratiprofessional.com',
    contactPhone: '0731-2553303',
    website: 'https://rgpgujaratiprofessional.com/',
    address: 'Near Bombay Hospital Service Road, Scheme No. 54, Indore - 452010, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 14 km)',
    approval: 'AICTE Approved, Affiliated to Devi Ahilya Vishwavidyalaya (DAVV)',
    selectionCriteria: 'Merit-based for undergraduate BCA/BBA; CMAT/DTE counseling for MBA.',
    updates: [
      'Admissions open for MBA, BBA, and BCA batches for 2026-27 session.',
      'Special merit concessions offered by Shri Gujarati Samaj trust.'
    ],
    coursesList: [
      { name: 'Master of Business Administration [MBA]', duration: '2 Years', fees: '₹55,000 (1st Year Fees)', specializations: ['Marketing', 'Finance', 'Human Resources'] },
      { name: 'Bachelor of Business Administration [BBA]', duration: '3 Years', fees: '₹48,000 (1st Year Fees)' },
      { name: 'Bachelor of Computer Applications [BCA]', duration: '3 Years', fees: '₹42,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 6.80 LPA',
      average: 'INR 3.20 LPA',
      lowest: 'INR 2.20 LPA',
      recruiters: ['ICICI Bank', 'Teleperformance', 'TCS', 'Axis Bank', 'Justdial']
    },
    facultyList: [
      { name: 'Dr. Rajiv Sharma', qualification: 'Director' },
      { name: 'Prof. Rashmi Saxena', qualification: 'Associate Professor, Management' }
    ],
    scholarships: [
      { name: 'Gujarati Samaj Merit Scholarship', criteria: 'Merit in 10+2 / Graduation', benefits: 'Up to 25% fee waiver' }
    ],
    cutoffs: [
      { course: 'Master of Business Administration [MBA]', rank: 'CMAT percentile 50+ or MP DTE merit' }
    ]
  },
  {
    id: 'iil-indore',
    name: 'Indore Institute of Law (IIL)',
    type: 'college',
    category: 'Law',
    boardOrAffiliation: 'Autonomous',
    location: 'Rau',
    ...
    indoreRating: 4.9,
    totalReviews: 1250,
    image: '/iil-indore.jpg',
    description: 'Indore Institute of Law (IIL Indore), established in 2003, is Central India\'s top-ranked dedicated law college. Approved by the Bar Council of India and affiliated with DAVV, IIL is renowned for its national moot court competitions, state-of-the-art mock parliament, high bar placement records, and elite 5-year integrated BA LLB and BBA LLB programs.',
    facilities: ['Grand Moot Court Hall', 'Mock Parliament', 'Air-Conditioned Law Library', 'LexisNexis & Manupatra Digital Database', 'Auditorium', 'Hostel (Boys & Girls)', 'Sports Complex'],
    establishedYear: 2003,
    coordinates: { lat: 22.6450, lng: 75.8250 },
    contactEmail: 'admissions@indoreinstituteoflaw.org',
    contactPhone: '0731-4011400',
    website: 'https://indoreinstituteoflaw.org/',
    address: 'Rau Pithampur Road, Opp. IIM Indore, Rau, Indore - 453331, Madhya Pradesh, India',
    nearestAirport: 'Devi Ahilya Bai Holkar Airport (approx 12 km)',
    approval: 'Bar Council of India (BCI) Approved, UGC Recognized, Affiliated to DAVV, NAAC Grade A Accredited',
    selectionCriteria: 'IILET (Indore Institute of Law Entrance Test) or CLAT / LSAT scores followed by personal interview.',
    updates: [
      'Registrations live for IILET 2026 for BA LLB (Hons), BBA LLB (Hons), and LLM programs.',
      'Winners of 14th National Animal Law Moot Court Competition announced.'
    ],
    coursesList: [
      { name: 'BA LLB (Hons)', duration: '5 Years', fees: '₹1,40,000 (1st Year Fees)' },
      { name: 'BBA LLB (Hons)', duration: '5 Years', fees: '₹1,50,000 (1st Year Fees)' },
      { name: 'Master of Laws [LLM]', duration: '1 Year', fees: '₹1,10,000 (1st Year Fees)' }
    ],
    placements: {
      highest: 'INR 14.00 LPA',
      average: 'INR 5.80 LPA',
      lowest: 'INR 3.50 LPA',
      recruiters: ['Khaitan & Co', 'Shardul Amarchand Mangaldas', 'Luthra & Luthra', 'HDFC Legal', 'TATA Sons Legal', 'Supreme Court Advocate Chambers']
    },
    facultyList: [
      { name: 'Dr. Manpreet Kaur Rajpal', qualification: 'Director & Professor of Law' },
      { name: 'Prof. Akshay Kanti Bam', qualification: 'Chairman & Senior Legal Jurist' }
    ],
    scholarships: [
      { name: 'IIL Judicial & CLAT Merit Scholarship', criteria: 'CLAT AIR top ranks / 90%+ 12th', benefits: 'Up to 50% tuition waiver' }
    ],
    cutoffs: [
      { course: 'BA LLB (Hons)', rank: 'IILET rank / CLAT Score cutoff' }
    ]
  }
];
...
export const ADMISSION_COURSES = CATEGORIES.college;
