      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-xs">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-100 text-xs text-gray-500">
                ...
                <div>
                  ...
                  <span className="text-gray-900 inline-flex items-center text-[11px] font-bold bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-md mt-0.5">
                    <LogoIcon className="h-3.5 w-3.5 mr-1.5 shrink-0" />
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-6">
              ...
              <div className="pt-4 border-t border-gray-100 space-y-2.5 text-xs">
                ...
                {institute.contactEmail ? (
                  ...
                  <div className="flex items-center space-x-2 text-gray-600">
                    <Mail className="h-4 w-4 text-gray-400" />
                    <a href="mailto:Indorecollegeshub@gmail.com" className="font-medium hover:underline hover:text-red-600 select-all">Indorecollegeshub@gmail.com</a>
                  </div>
                )}
                ...
                {institute.contactPhone ? (
                  ...
                  <div className="flex items-center space-x-2 text-gray-600">
                    <PhoneCall className="h-4 w-4 text-gray-400" />
                    <span className="font-medium">+91 9893509492</span>
                  </div>
                )}
              </div>
              ...
              <div className="pt-4 space-y-2.5">
                <button
                  ...
                  className="w-full bg-red-600 hover:bg-red-600 text-white font-bold text-xs py-3 rounded-xl transition flex items-center justify-center space-x-1.5 shadow-xs"
                >
        ...
        <div className="space-y-8 mt-12">
          ...
          {institute.updates && institute.updates.length > 0 && (
            <div className="bg-red-600/5 border border-red-100 rounded-2xl p-6 sm:p-8 shadow-3xs relative overflow-hidden">
              <div className="absolute top-0 right-0 h-24 w-24 bg-red-600/5 rounded-full filter blur-xl translate-x-4 -translate-y-4" />
              <h3 className="text-sm font-black text-red-600 mb-3.5 flex items-center space-x-2">
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700">
                    {institute.cutoffs.map((co, idx) => (
                      <tr key={idx} className="hover:bg-gray-50/50 transition duration-150">
                        ...
                        <td className="p-4 text-right font-black text-red-600 bg-red-50/10">{co.rank}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <form onSubmit={handleAddReview} className="border-t border-gray-100 pt-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="bg-red-600 hover:bg-red-600 text-white font-bold text-xs px-5 py-2.5 rounded-xl transition shadow-xs flex items-center space-x-1.5 disabled:opacity-50"
                >
