...
export default function Home({
  ...
  const REVIEWS = [
    ...
    },
    {
      ...
      comment: 'The counseling team helped us compare engineering colleges, fees, and placements without any pressure. We finally chose the right course for our daughter.',
      rating: 5,
      avatar: 'NS'
    },
    {
      name: 'Rahul Jain',
      role: 'Parent of BCA Aspirant',
      comment: 'Clear answers, honest guidance, and quick responses. The shortlist made our college visits much more focused and productive.',
      rating: 5,
      avatar: 'RJ'
    },
    {
      name: 'Pooja Verma',
      role: 'Parent of MBA Aspirant',
      comment: 'We received a practical comparison of MBA options in Indore with fees and admission timelines. It made the entire decision much easier.',
      rating: 5,
      avatar: 'PV'
    },
    {
      ...
      comment: 'The team listened to our budget and location preferences before recommending colleges. Their guidance felt personal and genuinely useful.',
      rating: 5,
      avatar: 'AJ'
    },
    {
      ...
      comment: 'The team explained medical admission steps clearly and helped us understand the options before counseling began. We felt prepared at every stage.',
      rating: 5,
      avatar: 'KP'
    },
    {
      ...
      comment: 'Professional, patient, and easy to reach. We received school recommendations that matched our child’s interests and our family priorities.',
      rating: 5,
      avatar: 'SM'
    }
  ];
      ...
      <section className="py-10 sm:py-12 bg-slate-50 border-y border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            {/* Right Col: Additional Parent Reviews */}
            <div className="lg:col-span-5">
              <div className="space-y-5">
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F244C] font-outfit">
                    Advice families can trust
                  </h3>
                </div>
                {REVIEWS.slice(4, 8).map((rev, idx) => (
                  <motion.div
                    key={idx}
                    whileHover={{ x: 4 }}
                    className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:shadow-md transition duration-200"
                  >
                    <div className="flex items-center justify-between gap-3 mb-3">
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 bg-slate-100 border border-slate-200 text-[#0F244C] text-xs font-bold rounded-full flex items-center justify-center">
                          {rev.avatar}
                        </div>
                        <div>
                          <h4 className="text-xs font-bold text-[#0F244C]">{rev.name}</h4>
                    ...
                    <p className="text-xs text-gray-600 leading-relaxed font-light italic">&ldquo;{rev.comment}&rdquo;</p>
                  </motion.div>
                ))}
              </div>
            </div>
